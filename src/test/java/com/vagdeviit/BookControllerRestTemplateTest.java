...
import com.vagdeviit.Book;
import com.vagdeviit.BookRepository;
...
public class BookControllerRestTemplateTest {
    ...
    @Before
    public void init() {
        Book book = new Book(1L, "Book Name", "vagdeviit", new BigDecimal("9.99"));
    ...
    public void find_bookId_OK() throws JSONException {
        ...
        String expected = "{id:1,name:\"Book Name\",author:\"vagdeviit\",price:9.99}";
    ...
    public void save_book_OK() throws Exception {
        ...
        Book newBook = new Book(1L, "Spring Boot Guide", "vagdeviit", new BigDecimal("2.99"));
    ...
    public void update_book_OK() throws Exception {
        ...
        Book updateBook = new Book(1L, "ABC", "vagdeviit", new BigDecimal("19.99"));
